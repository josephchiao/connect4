...
def point_mutaion(dataset, mutaion_rate):
    thetas = np.load(f'/home/joseph/Desktop/Connet 4/connect4/genetic_training_data/nn_theta_set_{dataset}.npz')
    ...
    np.savez(f'/home/joseph/Desktop/Connet 4/connect4/genetic_training_data/nn_theta_set_{dataset}.npz', Theta1 = theta_1, Theta2 = theta_2, Theta3 = theta_3)
