...
def player_vs_computer(nn_depth):
    ...
    thetas = np.load(f'/home/joseph/Desktop/Connet 4/connect4/genetic_elite_data/nn_theta_set_0.npz')
...
def nn_vs_random(theta_set, nn_depth, random_depth):
    ...
    thetas = np.load(f'/home/joseph/Desktop/Connet 4/connect4/genetic_training_data/nn_theta_set_{theta_set}.npz')
    theta_1 = thetas['Theta1']
    theta_2 = thetas['Theta2']
    theta_3 = thetas['Theta3']
...
def nn_vs_nn(player_1, player_2, nn_depth, trainer_depth):
    ...
    p1_thetas = np.load(f'/home/joseph/Desktop/Connet 4/connect4/genetic_trainer_data/nn_theta_set_{player_2}.npz')
    p1_theta_1 = p1_thetas['Theta1']
    p1_theta_2 = p1_thetas['Theta2']
    p1_theta_3 = p1_thetas['Theta3']

    p2_thetas = np.load(f'/home/joseph/Desktop/Connet 4/connect4/genetic_training_data/nn_theta_set_{player_1}.npz')
